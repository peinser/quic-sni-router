...
- No NEW_CONNECTION_ID learning: CID rotation after the handshake is not visible because handshake / 1-RTT packets are not decrypted. Long-lived sessions through aggressive NAT may break.
